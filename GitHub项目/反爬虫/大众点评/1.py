'''
@Author: your name
@Date: 2020-03-05 22:07:53
@LastEditTime: 2020-03-05 23:25:59
@LastEditors: Please set LastEditors
@Description: In User Settings Edit
@FilePath: \vscode_code\GitHub项目\反爬虫\大众点评\1.py
'''
import time
import requests
...
shop.to_csv(r"E:\vscode_code\GitHub项目\反爬虫\大众点评\shop.csv",encoding="utf_8_sig",index = False)