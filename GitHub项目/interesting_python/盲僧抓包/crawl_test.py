'''
@Author: your name
@Date: 2020-02-03 13:51:23
@LastEditTime : 2020-02-03 13:53:38
@LastEditors  : Please set LastEditors
@Description: In User Settings Edit
@FilePath: \vscode_code\GitHub项目\interesting_python\盲僧抓包\crawl_test.py
'''
import requests
import pandas as pd
...
def sxs_crawl(pages=30, kw='数据挖掘', c='全国'):
    ...
    job_list.to_csv(r'E:\vscode_code\GitHub项目\interesting_python\盲僧抓包\job_list.csv', index=False)
    ...
    job_detailed.to_csv(r'E:\vscode_code\GitHub项目\interesting_python\盲僧抓包\job_detailed.csv', index=False)
    ...
    com_detailed.to_csv(r'E:\vscode_code\GitHub项目\interesting_python\盲僧抓包\com_detailed.csv', index=False)
