'''
@Author: your name
@Date: 2020-01-30 14:55:54
@LastEditTime : 2020-01-31 10:46:24
@LastEditors  : Please set LastEditors
@Description: In User Settings Edit
@FilePath: \vscode_code\GitHub项目\interesting_python\jiaoshi.py
'''
import requests
import pandas as pd
    ...
    def parse_data(res, page):
        if res.status_code == 200:
            ...
            data = pd.DataFrame({'title': title, 'link': link, 'salary': salary,
                                 ...
                                 'com_type': com_type})
            if page == '1':
                data.to_csv('E:\\vscode_code\\GitHub项目\\interesting_python\\教师\\jiaoshi.csv', index=False, mode='a', header=True)
            else:
                data.to_csv('E:\\vscode_code\\GitHub项目\\interesting_python\\教师\\jiaoshi.csv', index=False, mode='a', header=False)
